  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <Card>
          <CardHeader>
            <CardTitle>{initialData ? 'Edit' : 'Create'} {categoryType} Category</CardTitle>
          </CardHeader>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <div className="flex items-center gap-2">
                          <Image src={field.value || "https://placehold.co/100x100.png"} alt={`Image ${index + 1} preview`} width={64} height={64} className="rounded-md object-cover h-16 w-16" data-ai-hint="interior design" />
                          <FormControl>
